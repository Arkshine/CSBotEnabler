...
run.options.add_option('--metamod', type='string', dest='metamod_path', default='', help='Path to Metamod source code')
run.options.add_option('--hlsdk', type='string', dest='hlsdk_path', default='', help='Path to the HLSDK')
